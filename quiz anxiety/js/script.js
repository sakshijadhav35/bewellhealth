...
function showResultbox() {
  ...
  if (userScore == 7) {
    let scoreTag = "<span><p>No Anxiety</p></span>";
    scoreText.innerHTML = scoreTag;
  } else if (userScore >= 5 && userScore <= 6) {
    let scoreTag = "<span><p>Low Anxiety </p> </span>";
    scoreText.innerHTML = scoreTag;
  } else if (userScore <= 4 && userScore >= 3) {
    let scoreTag = "<span><p> Moderate Anxiety </p> </span>";
    scoreText.innerHTML = scoreTag;
  } else {
    let scoreTag = "<span><p> Severe Anxiety</p> </span> ";
    scoreText.innerHTML = scoreTag;
  }
}
