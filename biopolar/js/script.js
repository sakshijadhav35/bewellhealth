...
function showResultbox() {
  ...
  if (userScore == 10) {
    let scoreTag = "<span><p>Bipolar Negative</p></span>";
    scoreText.innerHTML = scoreTag;
  } else if (userScore >= 7 && userScore <= 9) {
    let scoreTag = "<span><p> Little symptoms </p> </span>";
    scoreText.innerHTML = scoreTag;
  } else if (userScore <= 4 && userScore >= 6) {
    let scoreTag = "<span><p>Moderate symptoms  </p> </span>";
    scoreText.innerHTML = scoreTag;
  } else {
    let scoreTag = "<span><p> Bipolar Positive</p> </span> ";
    scoreText.innerHTML = scoreTag;
  }
}
