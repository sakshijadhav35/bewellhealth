...
function showResultbox() {
  ...
  if (userScore == 10) {
    let scoreTag = "<span><p>No depression</p></span>";
    scoreText.innerHTML = scoreTag;
  } else if (userScore >= 7 && userScore <= 9) {
    let scoreTag = "<span><p>Mild Depression</p> </span>";
    scoreText.innerHTML = scoreTag;
  } else if (userScore >= 4 && userScore <= 6) {
    let scoreTag = "<span><p>Moderate Depression</p> </span>";
    scoreText.innerHTML = scoreTag;
  } else {
    let scoreTag = "<span><p>Severe Depression</p></span> ";
    scoreText.innerHTML = scoreTag;
  }
}
