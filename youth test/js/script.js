...
function showResultbox() {
  ...
  if (userScore == 10) {
    let scoreTag = "<span><p>No Stress</p></span>";
    scoreText.innerHTML = scoreTag;
  } else if (userScore >= 7 && userScore <= 9) {
    let scoreTag = "<span><p>Minimal Stress </p> </span>";
    scoreText.innerHTML = scoreTag;
  } else if (userScore <= 4 && userScore >= 6) {
    let scoreTag = "<span><p> Moderate Stress </p> </span>";
    scoreText.innerHTML = scoreTag;
  } else {
    let scoreTag = "<span><p> Severe Stress</p> </span> ";
    scoreText.innerHTML = scoreTag;
  }
}
